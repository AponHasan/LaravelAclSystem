...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-sm-12">
			<a href="{{route('user.list')}}" class="btn btn-primary btn-sm">Back</a>
			<div class="card">
							...
							<div class="col-sm-12">
								<table class="table table-bordered">
									...
									<tr>
										...
										@foreach($permissions as $permission)
										<td>
											<input type="checkbox" name="permission[]" value="{{$permission->id}}" {{ $user->user_permissions->contains($permission) ? 'checked' : '' }}>
										</td>
										@endforeach
									</tr>
								</table>
